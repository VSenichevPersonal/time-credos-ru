...
export default defineObject({
  ...
  fields: [
    ...
    // REQ-0013 13a: доли участия отдела в мульти-отдел проектах (ONE_TO_MANY).
    {
      universalIdentifier: CREDOS_TIME_DEPARTMENT_PROJECT_SHARES_FIELD_ID,
      name: 'projectShares',
      type: FieldType.RELATION,
      label: 'Доли в проектах',
      icon: 'IconChartPie',
      relationTargetObjectMetadataUniversalIdentifier:
        CREDOS_TIME_PROJECT_DEPARTMENT_OBJECT_UNIVERSAL_IDENTIFIER,
      relationTargetFieldMetadataUniversalIdentifier:
