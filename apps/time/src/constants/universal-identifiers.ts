...
// gap-аудит v3 #4: правила валидации таймшита как данные (лимит/недобор/откл.).
export const CREDOS_TIME_SETTINGS_MAX_HOURS_PER_DAY_FIELD_ID =
  '9f95aa16-1f81-49df-beb0-7bb73bbde883';
export const CREDOS_TIME_SETTINGS_MIN_HOURS_PER_WEEK_FIELD_ID =
