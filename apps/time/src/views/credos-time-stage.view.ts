...
// Index-view этапов. Колонки = код этапа, название, проект, статус, плановые часы.
export default defineView({
  ...
  fields: [
    ...
    // P2: человекочитаемое название этапа.
    {
      universalIdentifier: 'e291c20b-e6b8-4526-b70c-0f1aa01eb8be',
      fieldMetadataUniversalIdentifier: CREDOS_TIME_STAGE_NAME_FIELD_ID,
      position: 1,
      isVisible: true,
      size: 240,
    },
