...
// demo test fixture — НЕ живой секрет: API-ключ демо-workspace (sub/workspaceId=20202020…)
// для локальных integration-тестов. Allowlisted в secret-scan (arch #9, CISO-009). Ротация не нужна.
