> Источник: https://docs.twenty.com/developers/extend/apps/layout/command-menu-items.md — скачано 2026-06-20

# Command Menu Items

> Surface front components as quick actions and command menu (Cmd+K) entries with defineCommandMenuItem.
