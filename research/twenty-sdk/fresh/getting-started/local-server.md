> Источник: https://docs.twenty.com/developers/extend/apps/getting-started/local-server.md — скачано 2026-06-20

# Local Server

> Manage the local Twenty Docker server — start, stop, upgrade, parallel test instance, and manual SDK setup.
