> Источник: https://docs.twenty.com/developers/extend/apps/getting-started/scaffolding.md — скачано 2026-06-20

# Scaffolding

> Generate entity files interactively with yarn twenty dev:add — objects, fields, views, logic functions, and more.
