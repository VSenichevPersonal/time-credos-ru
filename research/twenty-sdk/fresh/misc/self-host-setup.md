> Источник: https://docs.twenty.com/developers/self-host/capabilities/setup.md — скачано 2026-06-20
...
**In production (NODE\_ENV=production):** Both logic functions and code interpreter default to **Disabled**. You must explicitly enable them with `LOGIC_FUNCTION_TYPE` and `CODE_INTERPRETER_TYPE` if you need these features.

**In development (NODE\_ENV=development):** Both default to **LOCAL** for convenience when running locally.
