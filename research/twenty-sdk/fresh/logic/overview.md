> Источник: https://docs.twenty.com/developers/extend/apps/logic/overview.md — скачано 2026-06-20

# Overview

> Server-side TypeScript that runs inside Twenty — triggered by HTTP routes, cron schedules, database events, AI tools, or workflow actions.
...
- **Logic Functions** (`/developers/extend/apps/logic/logic-functions`) — The core building block — trigger types, payloads, and the typed API client.
- **Skills & Agents** (`/developers/extend/apps/logic/skills-and-agents`) — Reusable AI agent instructions and assistants with custom system prompts.
- **Connections** (`/developers/extend/apps/logic/connections`) — OAuth credentials your app holds for third-party services — Linear, GitHub, Slack, and more.
