> Источник: https://docs.twenty.com/developers/extend/apps/config/install-hooks.md — скачано 2026-06-20

# Install Hooks

> Run logic before or after the install — seed data, back up records, validate the upgrade.
