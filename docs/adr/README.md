...
| [0003](0003-catalog-separate-app-shared-master-data.md) | Каталог — отдельный app, общие мастер-данные | ⚠️ SUPERSEDED (0010) | PoC: cross-app кастом-ссылки не работают; контент-решения (модель Service) в силе |
...
| [0009](0009-cross-app-object-references.md) | Cross-app ссылки (catalog↔time) | ⚠️ SUPERSEDED (0010) | PoC опроверг: cross-app кастом-ссылки не резолвятся в 2.14 |
| [0010](0010-single-app-logical-modules.md) | Единый app, логические модули | ACCEPTED | time + каталог в одном app; модули = nav-папки + префиксы credosTime*/credosCatalog*; связи intra-app |
