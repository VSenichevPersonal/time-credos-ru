...
> **Заметка:** Имена сотрудников в отчётах скрыты до завершения настройки системы контроля доступа. Строки сотрудников отображаются без ФИО — это сделано намеренно по требованиям безопасности.
...
| **Утилизация (%)** | Доля часов «на клиента» от нормы |
...
> *ФИО сотрудников скрыты до реализации полного RBAC.
...
| **Утилизация** | Процент часов категории «На клиента» от нормы |
...
| **Линия % (утилизация)** | Доля часов «на клиента» от нормы — отображается поверх столбцов |
...
> ⚠️ **Важно:** В экспорте данные сотрудников сохраняются в соответствии с текущими настройками видимости. На данный момент имена скрыты согласно требованиям безопасности (CISO-007).
