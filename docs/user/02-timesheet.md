...
Если вам нужна ещё одна строка с тем же проектом (но другим видом работ):

1. Наведите мышь на существующую строку — появится кнопка **«⊕ Дублировать»**.
2. Нажмите её — форма добавления откроется с уже выбранным проектом, останется только выбрать другой вид работ.
...
1. Кликните на ячейку нужного дня.
2. Введите число (допустимые форматы: `8`, `7.5`, `0.5`).
3. Нажмите **Tab** или кликните на другую ячейку — часы сохранятся автоматически.

> ⚠️ **Важно:** Дробные часы вводятся через точку: `1.5` означает «1 час 30 минут». Запятая не поддерживается.
...
2. Нажмите **Shift+Enter** — это значение будет применено ко всем рабочим дням строки (Пн–Пт), не затрагивая выходные.

> **Заметка:** Shift+Enter заполняет именно рабочие дни (по производственному календарю). Ячейки выходных остаются пустыми.

### Клавиатурная навигация

| Действие | Клавиша |
|----------|---------|
| Следующая ячейка (вправо) | Tab |
| Предыдущая ячейка (влево) | Shift+Tab |
| Ячейка ниже | ↓ |
| Ячейка выше | ↑ |
| Ячейка влево | ← |
| Ячейка вправо | → |
| Заполнить будни строки | Shift+Enter |
